using examenInsertEF8.Context;
using examenInsertEF8.Models;
using examenInsertEF8.ViewModel;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace examenInsertEF8.Controllers
{
    public class EmpleadoController : Controller
    {
        private readonly examenInsertEF8Context _context;
        public EmpleadoController(examenInsertEF8Context context)
        {
            _context = context;
        }
